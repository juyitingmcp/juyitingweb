...
基于 Next.js 的 AI 人格协作平台，支持多种 AI 人格的智能协作和场景化应用。

## 特色功能

- **AI人格大厅**: 支持多种专业AI人格，包括：
  - **女仆** - 情感支持者，提供温暖体贴的支持和鼓励
  - **效率狂** - 执行优化者，专注高效执行和时间管理
  - **数据帝** - 客观分析者，基于数据和事实进行分析
  - **点子王** - 创意激发者，天马行空的创意思维

- **智能协作**: 多人格团队协作，提供全方位的问题分析和解决方案
- **场景模板**: 专业的场景模板，快速启动不同工作场景的协作
- **国际化支持**: 支持中英文切换
- **响应式设计**: 适配各种设备和屏幕尺寸
...
- **思维帝** - 结构化思维专家，运用MECE原则进行系统分析
- **谨慎派** - 风险评估专家，识别潜在风险和制定预防措施
